...
<html>
	<head>
		<meta charset='utf8'/>
		<title><?php echo ($siteInfo["sitetitle"]); ?>-注册</title>
					...
					<div class='box'>
						...
						<div class='content'>
							<div class='Registered'>
								<div class='left'>
									<div class='block1'><img src='/Find/Public/style/info.png' />免費註冊帳號</div>
									<div class='block2'>
									<form action="<?php echo U('Registered/index');?>" method='post'>
										<p><span     class='msg'>帐号：</span><input name='user' type='text' /><span class='fj'>*</span></p>
											...
											<p><span class='msg'>确认密码：</span><input name='pswdOk' type='text' /><span class='fj'>*</span></p>
