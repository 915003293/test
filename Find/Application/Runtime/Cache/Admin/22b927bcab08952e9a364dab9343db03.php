                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Type/Add');?>">
                                <div class="form-group has-success"><label class="col-sm-4 control-label">分类名称</label>

                                    <div class="col-sm-3"><input type="text" class="form-control" name="title"  ></div>
                                </div>
                                     <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-4 control-label">上级分类</label>
									...
									<?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><option   value="<?php echo ($vo["id"]); ?>" >										
												<?php echo ($vo["title"]); ?>
