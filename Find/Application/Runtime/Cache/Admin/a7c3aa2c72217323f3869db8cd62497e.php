        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php if(is_array($ruleList)): foreach($ruleList as $k=>$vo): ?><tr class="gradeU">
                        <td>
                        ...
                        <td>					
						   ...
						   <?php if($vo["status"] == 0): ?><a href="<?php echo U('Jurisdiction/startRule',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon glyphicon glyphicon-record"></button></a>
						   <?php else: ?>
							  <a href="<?php echo U('Jurisdiction/banRule',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon glyphicon-ban-circle"></button></a><?php endif; ?>
						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  ...
							  <div class="modal-footer">
								...
								<a href="<?php echo U('Jurisdiction/deleteRule',array('id'=>$vo['id']));?>" /><button type="button"  class="btn btn-primary">OK</button></a>
							  </div>
							</div>
						  </div>
