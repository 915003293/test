        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
					...
					<form action="<?php echo U('Article/handleAll');?>" method='post'>
                    ...
                    <tbody>
                    <?php if(is_array($listData)): foreach($listData as $k=>$vo): ?><tr class="gradeU">
                        <td><input type="checkbox" class='checkbox1' name = "selected[]"  style='height:30px;width:50px;' value='<?php echo ($vo["id"]); ?>'></td>
                        <td><?php echo ($vo["title"]); ?></td>
                        <td><?php echo ($vo["i"]); ?></td>
                        <td><?php echo ($vo["createdate"]); ?></td>
                        <td>
                           <a href="<?php echo ($vo["link"]); ?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon glyphicon-paperclip"></button></a>
                           <a onclick="alert('作者偷懒了,功能正在开发中');"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon-pencil"></button></a>                        
						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">find-刪除文章</h4>
							  </div>
							  <div class="modal-body">
								你确定要删除：<?php echo ($vo["title"]); ?> 这篇文章吗？
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">NO</button>
								<a href="<?php echo U('Article/handleOne',array('id'=>$vo['id'],'type'=>'delete'));?>" /><button type="button"  class="btn btn-primary">OK</button></a>
							  </div>
							</div>
						  </div>
                    ...
                    <div style='position:relative; top:-15px;'> <?php echo ($page); ?></div>
                    </div>
                </div>
            </div>
            </div>
