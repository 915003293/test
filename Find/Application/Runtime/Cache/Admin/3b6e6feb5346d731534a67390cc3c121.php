        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
				   ...
				   <form action="<?php echo U('Type/DeleteAll');?>" method='post'>
				   <div class="ibox-content">
                    ...
                    <tbody>
                    <?php if(is_array($arr)): $i = 0; $__LIST__ = array_slice($arr,$p*$showNum,$showNum,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class="gradeU">
						<td>
                        ...
                        <td>
                           ...
                           <a href="<?php echo U('Type/Edit',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon-pencil"></button></a>                        
						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">find-刪除分类</h4>
							  </div>
							  ...
							  <div class="modal-footer">
								...
								<a href="<?php echo U('Type/Delete',array('id'=>$vo['id']));?>" /><button type="button"  class="btn btn-primary">OK</button></a>
							  </div>
							</div>
						  </div>
