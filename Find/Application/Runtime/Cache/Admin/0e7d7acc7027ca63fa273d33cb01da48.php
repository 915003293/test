        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php if(is_array($groupList)): foreach($groupList as $k=>$vo): ?><tr class="gradeU">
                        <td>
							<input type="checkbox" class='checkbox1' name = "id[]"  style='height:30px;width:50px;' value='<?php echo ($vo["id"]); ?>'>
						</td>
                        <td><?php echo ($vo["title"]); ?></td>			
                        <td><?php echo ($vo["describe"]); ?></td>			
                        <td><?php if($vo["status"] == 0): ?><span class="label label-danger">禁用</span><?php else: ?><span  class="label label-info">启用</span><?php endif; ?></td>
                        <td>					
                       
						   <?php if($vo["status"] == 0): ?><a href="<?php echo U('Jurisdiction/startGroup',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon glyphicon glyphicon-record"></button></a>
						   <?php else: ?>
							  <a href="<?php echo U('Jurisdiction/banGroup',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon glyphicon-ban-circle"></button></a><?php endif; ?>
                           <a href="<?php echo U('Jurisdiction/editGroup',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon-pencil"></button></a>                        
						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								你确定要删除:<?php echo ($vo['title']); ?>吗？
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">NO</button>
								<a href="<?php echo U('Jurisdiction/deleteGroup',array('id'=>$vo['id']));?>" /><button type="button"  class="btn btn-primary">OK</button></a>
							  </div>
							</div>
						  </div>
