        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form action="<?php echo U('Friendlink/DeleteAll');?>" method='post'>
					...
					<?php if(is_array($linkList)): foreach($linkList as $k=>$vo): ?><tr class="gradeU">
                        <td>
                        ...
                        <td>
						 ...
						 <a href="<?php echo U('Friendlink/Edit',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-default btn-lg glyphicon glyphicon-pencil"></button></a>                        
						  ...
						  <div class="modal-dialog">
							<div class="modal-content">
							  <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">find-刪除友情链接</h4>
							  </div>
							  ...
							  <div class="modal-footer">
								...
								<a href="<?php echo U('Friendlink/Delete',array('id'=>$vo['id']));?>" /><button type="button"  class="btn btn-primary">OK</button></a>
							  </div>
							</div>
						  </div>
					...
					<input type='submit'  style='margin-right:10px;' class="btn btn-primary" value='删除'/>
                    </tbody>
