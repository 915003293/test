...
<body class="gray-bg" style="">
     <div id="bg">
        <img src="/Find/Public/img/5.jpg" alt="">
    </div>
    <div>
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <h3 style="color:#fff;">find管理后台</h3>
            ...
            <form class="m-t" role="form" action="<?php echo U('Login/login');?>" method="post">
                <div class="form-group">
                    <input type="username" class="form-control" placeholder="用户名" name="username1">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="密码"  name="password1">
                </div>
                <button type="submit" name='submit' value='v' class="btn btn-primary block full-width m-b">Login</button>

                <a href="javascript:void(0);" onclick="alert('正在开发中······');"><small>忘记密码?</small></a>
                <!-- <p class="text-muted text-center"><small>Do not have an account?</small></p> -->
                <!-- <a class="btn btn-sm btn-white btn-block" href="register.html">Create an account</a> -->
            </form>
            <p class="m-t"> <small>find版权所有&copy; 2016</small> </p>
        </div>
    </div>
